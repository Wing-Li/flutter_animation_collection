      ...
      final bulletWidget = AnimatedBuilder(
        ...
        builder: (BuildContext context, Widget child) {
          ...
          if (context.findRenderObject() != null) {
            ...
            // if (box != null && animation.value > (fixedWidth + widgetWidth)) {
            //   _lastBullets[nextChannel]?.updateWith(position: double.infinity);
            //   return const SizedBox();
            // }
          }

//          debugPrint('${_lastBullets[nextChannel]?.id} == ${context.hashCode} $child pos: ${animation.value}');
...
class HashList<T> {
  ...
  Map<int, HashSet<T>> _map = new HashMap();
